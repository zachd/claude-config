...
- **Don't do step-work in the orchestrator.** Don't edit the step files or repo tooling mid-run, and don't script CI/build polling inline in your own context — delegate build/CI observation to a subagent so your context stays uncluttered.
